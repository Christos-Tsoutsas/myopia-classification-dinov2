# =====================================================================================
# Myopia Classification – Experiment 7 (DINO-v2 ViT-B/14)
# -----------------------------------------------------------------------------
# Upgrades over Exp-6:
...
REPORTS_PATH = os.path.join(PROJECT_PATH, "reports_experiment_8")
MODELS_PATH = os.path.join(PROJECT_PATH, "models_experiment_8")
...
WEIGHT_DECAY = 0.05
MODEL_NAME = "vit_base_patch14_dinov2"  # DINO-v2 checkpoint (timm >= 0.9.10)
...
def main():
    ...
    print(f"[INFO] {datetime.now():%Y-%m-%d %H:%M} – Starting Exp-7 on {DEVICE}")
